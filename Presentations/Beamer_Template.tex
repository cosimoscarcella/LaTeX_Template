...
\hypersetup {
    ...
    pdfauthor={Cosimo Scarcella},     % author
    pdfsubject={Cosimo Scarcella},   % subject of the document
    pdfcreator={Cosimo Scarcella},   % creator of the document
    pdfproducer={Cosimo Scarcella}, % producer of the document
...
\author{Cosimo Scarcella} % Your name
...
\bibitem[Cosimo, 2015]{p1} Cosimo Scarcella (2015)
